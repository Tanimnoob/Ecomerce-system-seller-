...
<html>
<head>
<link rel= "stylesheet"  type="text/css" href="../Css/condition.css?v=1" />
</head>
<body> 


<p class="solid"><strong>Terms and Conditions</strong></p>
<p class="solid">Our Terms and Conditions were last updated on [___DATE___].</p>
<p class="solid">Please read these terms and conditions carefully before using Our Service.</p>
<p class="solid"><strong>Interpretation and Definitions</strong></p>
<p class="solid"><strong>Interpretation</strong></p>
<p class="solid">The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
<p class="solid"><strong>Definitions</strong></p>
<p class="solid">For the purposes of these Terms and Conditions:</p>
<p class="solid"><strong>"Affiliate"</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</p>
<p class="solid"><strong>"Account"</strong> means a unique account created for You to access our Service or parts of our Service.</p>

<p class="solid"><strong>"Company"</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to [___COMPANY_INFORMATION___].</p>

<p class="solid"><strong>"Country"</strong> refers to [___COMPANY_COUNTRY___].</p>

<p class="solid"><strong>"Content"</strong> refers to content such as text, images, or other information that can be posted, uploaded, linked to or otherwise made available by You, regardless of the form of that content.</p>

<p class="solid"><strong>"Device"</strong> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</p>

<p class="solid"><strong>"Feedback"</strong> means feedback, innovations or suggestions sent by You regarding the attributes, performance or features of our Service.</p>

<p class="solid"><strong>"Service"</strong> refers to the Website.</p>

<p class="solid"><strong>"Terms and Conditions"</strong> (also referred as "Terms" or "Terms of Use") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions Agreement was generated by <a href="https://www.termsfeed.com/blog/sample-terms-and-conditions-template/">TermsFeed Terms and Conditions Template</a>.</p>

<p class="solid"><strong>"Third-party Social Media Service"</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</p>

<p class="solid"><strong>"Website"</strong> refers to [___WEBSITE_NAME___], accessible from [___WEBSITE_URL___]</p>

<p class="solid"><strong>"You"</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>

<p class="solid"><strong>Acknowledgment</strong></p>
<p class="solid">These are the Terms and Conditions governing the use of this Service and the agreement that operates between You and the Company. These Terms and Conditions set out the rights and obligations of all users regarding the use of the Service.</p>
<p class="solid">Your access to and use of the Service is conditioned on Your acceptance of and compliance with these Terms and Conditions. These Terms and Conditions apply to all visitors, users and others who access or use the Service.</p>
<p class="solid">By accessing or using the Service You agree to be bound by these Terms and Conditions. If You disagree with any part of these Terms and Conditions then You may not access the Service.</p>
...
<p class="solid"><strong>Waiver</strong></p>
<p class="solid">Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not effect a party's ability to exercise such right or require such performance at any time thereafter nor shall be the waiver of a breach constitute a waiver of any subsequent breach.</p>
<p class="solid"><strong>Translation Interpretation</strong></p>
<p class="solid">These Terms and Conditions may have been translated if We have made them available to You on our Service.<br/>
You agree that the original English text shall prevail in the case of a dispute.</p>
<p class="solid"><strong>Changes to These Terms and Conditions</strong></p>
<p class="solid">We reserve the right, at Our sole discretion, to modify or replace these Terms at any time. If a revision is material We will make reasonable efforts to provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material change will be determined at Our sole discretion.</p>
<p class="solid">By continuing to access or use Our Service after those revisions become effective, You agree to be bound by the revised terms. If You do not agree to the new terms, in whole or in part, please stop using the website and the Service.</p>
<p class="solid"><strong>Contact Us</strong></p>
<p class="solid">If you have any questions about these Terms and Conditions, You can contact us:</p>
